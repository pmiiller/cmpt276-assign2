...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { description: @thing.description, person_id: @thing.person_id, tname: @thing.tname }
    end
  ...
  test "should update thing" do
    patch :update, id: @thing, thing: { description: @thing.description, person_id: @thing.person_id, tname: @thing.tname }
    assert_redirected_to thing_path(assigns(:thing))
  end
